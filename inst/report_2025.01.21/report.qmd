...
#load( here::here("data","end_state_iter14_forreport.rdata"))
...
```{r, child = here::here("inst", "report_2025.01.21", "child1_preamble.qmd")}
```

\newpage

```{r, child = here::here("inst", "report_2025.01.21", "child2.qmd")}
```
...
save.image(file = here::here("inst","report","end_state_2021.01.21.rdata"))
```
